$(document).ready(function () {
    var e,
        s = [];
    $("#users-list-datatable").length > 0 &&
        (e = $("#users-list-datatable").DataTable({
        ...
        $("#users-language-select2").length > 0 &&
            $("#users-language-select2").select2({
                dropdownAutoWidth: !0,
                width: "100%",
            }),
        $("#users-music-select2").length > 0 &&
            $("#users-music-select2").select2({
                dropdownAutoWidth: !0,
                width: "100%",
            }),
        $("#users-movies-select2").length > 0 &&
            $("#users-movies-select2").select2({
                dropdownAutoWidth: !0,
                width: "100%",
            }),
        $(".birthdate-picker").length > 0 &&
