...
$(document).ready(function () {
    $(".row-grouping").DataTable({
        ...
        responsive: !0,
        rowReorder: !0,
        columnDefs: [{ visible: !1, targets: 5 }],
        displayLength: 25,
    ...
    $(".row-grouping tbody").on("click", "tr.group", function () {
        if ("undefined" != typeof table && table.order()[0]) {
            var currentOrder = table.order()[0];
            5 === currentOrder[0] && "asc" === currentOrder[1]
    ...
    var checkAll = $("input.input-chk-all"),
        checkboxes = $("input.input-chk");
    checkAll.on("ifChecked ifUnchecked", function (event) {
        "ifChecked" == event.type
