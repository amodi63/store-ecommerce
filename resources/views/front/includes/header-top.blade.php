            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
                    ...
                    <div id="_desktop_language_selector"
                        ...
                        <div class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                            role="main">
                            <span class="expand-more"><img class="img-fluid" src="img/1.jpg" alt="English"
                                ...
                                <div class="language-item current flex-first">
                                    <div class="current">
                                        <a href="index.htm?home=home_3">
                                            <img class="img-fluid" src="img/1.jpg" alt="English" width="16"
                                                height="11">
                                            <span>English</span>
                                        </a>
                                    </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/es/?home=home_3">
                                            <img class="img-fluid" src="img/2.jpg" alt="Español" width="16"
                                                height="11">
                                            <span>Español</span>
                                        </a>
                                    </div>
                                ...
                                <div class="language-item">
                                    <div>
                                        <a href="http://demo.bestprestashoptheme.com/savemart/pl/?home=home_3">
                                            <img class="img-fluid" src="img/5.jpg" alt="Polski" width="16"
                                                height="11">
                                            <span>Polski</span>
                                        </a>
                                    </div>
