    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('admin/category.main_categories')}}</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Category::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.categories.index','main-category' )}}"
                                          data-i18n="nav.dash.ecommerce">{{__('admin/category.all_categories')}}</a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.categories.create', 'main-category')}}" data-i18n="nav.dash.crypto">{{__('admin/category.add_category')}}</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{__('admin/category.sub_categories')}}</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{ App\Models\Category::child()->count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.categories.index','sub-category' )}}"
                                          data-i18n="nav.dash.ecommerce"> {{__('admin/category.all_sub_categories')}} </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.categories.create','sub-category' )}}" data-i18n="nav.dash.crypto">
                        {{__('admin/category.add_sub_category')}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/sidebar.shipping_method')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('admin/sidebar.free_shipping')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','local')}}">{{__('admin/sidebar.local_shipping')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.setting.shipping.edit','outer')}}"
