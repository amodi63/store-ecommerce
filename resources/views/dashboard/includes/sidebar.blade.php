    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{ __('user/user.users') }}</span>
                    <span
                        class="badge badge badge-danger badge-pill float-right mr-2">{{ \App\Models\User::count() }}
                    </span>
                </a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">{{ __('admin/category.all_categories') }}</span>
                    <span
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('admin.brands.create') }}"
                            data-i18n="nav.dash.crypto">{{ __('admin/brand.add_n_brand') }} </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li><a class="menu-item" href="{{ route('admin.tags.create') }}"
                            data-i18n="nav.dash.crypto">{{ __('admin/tag.add_n_tag') }} </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-male"></i>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#"
                            data-i18n="nav.templates.vert.main">{{ __('admin/sidebar.shipping_method') }}</a>
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item"
                                    href="{{ route('admin.setting.shipping.edit', 'local') }}">{{ __('admin/sidebar.local_shipping') }}</a>
                            </li>
