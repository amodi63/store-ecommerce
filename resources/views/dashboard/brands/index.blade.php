                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">{{__('admin/category.all_main_categories')}}</h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            class="table display nowrap table-striped table-bordered scroll-horizontal" style="width:100% !important">
                                            <thead class="">
                                            <tr>
                                                <th>id </th>
                                            ...
                                            @isset($brands)
                                                ...
                                                <tr>
                                                    <td>{{$brand->id}}</td>
                                                    <td>{{$brand->name}}</td>
                                                    <td> <img style="width: 150px; height: 100px;" src="{{$brand->getPhotoAttr($brand->photo)}}"/></td>
