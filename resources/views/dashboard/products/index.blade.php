                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{ __('admin/product.all_products') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <table class="table display nowrap table-striped table-bordered scroll-horizontal"
                                            ...
                                            <thead >
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{ __('admin/category.measures') }}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @isset($products)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="btn-group" role="group"
                                                                    ...
                                                                    <a href="{{ route('admin.products.edit', [$product->id]) }}"
                                                                        class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">{{ __('admin/product.inventroy') }}</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    @endforeach
